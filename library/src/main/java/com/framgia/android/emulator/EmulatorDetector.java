...
public final class EmulatorDetector {
    ...
    private boolean checkAdvanced() {
        ...
        Log.e("Andy", checkTelephony()+"");
        Log.e("Andy", checkFiles(GENY_FILES,"Geny")+"");
        Log.e("Andy", checkFiles(ANDY_FILES,"Andy")+"");
        Log.e("Andy", checkFiles(NOX_FILES,"Nox")+"");
        Log.e("Andy", checkQEmuDrivers()+"");
        Log.e("Andy", checkFiles(PIPES,"Pipes")+"");
        Log.e("Andy", checkIp()+"");
        Log.e("Andy", (checkQEmuProps() && checkFiles(X86_FILES,"X86"))+"");
